...
G = 0.3
SPEEDFLY = -4
BIRDIMG = pygame.image.load('img/spaceshuttle.png')
...
DISTANCE = 300
COLUMNSPEED = 1
COLUMNIMG = pygame.image.load('img/Obstacle.png')

BACKGROUND = pygame.image.load('img/space.v3.png')
...
def gameStart(bird):
    ...
    headingSuface = font.render('SPACE RUNNER', True, (255, 0, 0))
...
def gameOver(bird, columns, score):
    ...
    scoreSuface = font.render('Score: ' + str(score.score), True, (255, 255, 255))
